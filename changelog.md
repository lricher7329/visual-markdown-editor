...
- Reorganized toolbar with Insert dropdown menu for cleaner UI
- Added custom Insert Image function using native file picker
- Improved code quality: replaced console statements with Output class
- Fixed deprecated .substr() method usage
- Improved type safety in Output class
